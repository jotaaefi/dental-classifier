...
def treinar_modelo_arvore(df, max_depth=None, salvar_modelo=True):
    ...
    print(f"Acurácia do modelo de Árvore de Decisão no conjunto de teste: {accuracy:.2f}")
    ...
    if salvar_modelo:
        ...
        print("✅ Modelo salvo como 'modelo_arvore.pkl'.")
...
def carregar_modelo(caminho_modelo="modelo_arvore.pkl"):
...
modelo_arvore = treinar_modelo_arvore(df_treino, max_depth=10)  # Testando com profundidade 10

df_valida = pd.read_csv(r'csv\tabela_validar.csv')
validar_modelo(df_valida, modelo_arvore)
